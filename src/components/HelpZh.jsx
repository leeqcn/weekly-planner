    ...
    <div className="help-view">
      ...
      <section className="card">
        ...
        <p className="muted small">
          ...
          不然手指落在块上就滚不动 24 小时的时间轴了。那两道条上
          <b>点一下不拖</b>也算点在块上，不会白点。
        </p>
        <p className="muted small">
          半小时的块只有 26 像素高，手指本来就不好点准。
          <b>双击只是快捷方式</b>：选中之后，屏幕底下那条浮条上有「完成」，
          效果一模一样。
        </p>
        <p className="muted small">
      ...
      <section className="card">
        ...
        <ul>
          <li>
            ...
            <b>点格子在 100 / 50 / 0 之间循环</b>，和日视图里是同一个操作。
          </li>
          <li>
      ...
      <section className="card">
        ...
        <details>
          <summary>趋势图怎么看</summary>
          <ul>
            <li>
              <b>一个点 = 一周</b>，横轴从最早那周到最近那周。
              <b>细线</b>是每周实际，<b>粗线</b>是 EWMA（平滑之后的水平）——
              两条分开是为了让你看出「这一周的高低是不是意外」：
              细线跳、粗线不动，那就是意外。
            </li>
            <li>
              左边两个数是纵轴的<b>上下界</b>，右边那个是<b>最近一周</b>的值。
            </li>
            <li>
              <b>纵轴不是从 0 开始</b>的（不然常年差不多的曲线就是一条贴顶的直线）。
              代价是波动看起来比实际大 —— 看变化的方向，别看斜率有多陡。
            </li>
            <li>
            ...
            <li>
              <b>还没过完的那一周同样不参与。</b>周三看的话本周只有 3 天，
              拿它去和整周比，趋势线永远在最后掉下去、EWMA 跟着被拽低 ——
              那不是做少了，是还没过完。也<b>不折算</b>（不拿 3 天推整周）：
              周末和工作日根本不是一回事，推出来的是个看着精确的假数。
            </li>
            <li>
              只有<b>按周比</b>的数受这条影响（趋势、EWMA、周均值）。
              日均、日最少/最多、占比都是除以「做过的天数」，半周照常全算。
            </li>
          </ul>
        </details>
      </section>
      ...
      <section className="card">
        ...
        <ul>
          <li>
            点一下在 <b>100 / 50 / 0</b> 之间循环，日视图和周视图一个操作。
            数字上的底色就是状态（绿 / 黄 / 红），不用再看第二列。
          </li>
          <li>
            只有三档是故意的：记录本来就只分「做完了 / 做了一半 / 没做」，
            精确到 70% 既拿不准也没人回头看，还要在手机上跟滑块较劲。
          </li>
        </ul>

        <h2>一天的时间去哪了</h2>
        <p>
          日视图时间轴下面有一条<b>横的堆叠条</b>：<b>按分类</b>把实际时间加起来，
          一段一类，标着时长。不到一小时的段只留颜色，清单里合并成一行「不到一小时的」——
          这一页要回答的是「大头在哪」，不是每件小事各花了几分钟。
          想看具体哪件事，上面时间轴里就是。
        </p>
        <p className="muted small">
          分母不是 24 小时，是<b>已经过去的那部分</b> —— 下午三点看就是 15 小时。
          拿 24 小时当分母的话，早上看什么都显得「占比很小」。
          斜纹那段是<b>没记录</b>的时间，画出来占比才加得到 100%。
        </p>
